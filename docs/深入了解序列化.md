...
<img src="https://raw.githubusercontent.com/dunwu/images/dev/snap/20200630204142.png" alt="" style="zoom:200%;" />

- [1. Java 序列化简介](https://dunwu.github.io/javacore/io/java-serialization.html#1-java-序列化简介)
- [2. Java 序列化和反序列化](https://dunwu.github.io/javacore/io/java-serialization.html#2-java-序列化和反序列化)
- \3. Serializable 接口
  - [3.1. serialVersionUID](https://dunwu.github.io/javacore/io/java-serialization.html#31-serialversionuid)
  - [3.2. 默认序列化机制](https://dunwu.github.io/javacore/io/java-serialization.html#32-默认序列化机制)
  - [3.3. transient](https://dunwu.github.io/javacore/io/java-serialization.html#33-transient)
- \4. Externalizable 接口
  - [4.1. Externalizable 接口的替代方法](https://dunwu.github.io/javacore/io/java-serialization.html#41-externalizable-接口的替代方法)
  - [4.2. readResolve() 方法](https://dunwu.github.io/javacore/io/java-serialization.html#42-readresolve-方法)
- [5. Java 序列化问题](https://dunwu.github.io/javacore/io/java-serialization.html#5-java-序列化问题)
- [6. Java 序列化的缺陷](https://dunwu.github.io/javacore/io/java-serialization.html#6-java-序列化的缺陷)
- [7. 序列化技术选型](https://dunwu.github.io/javacore/io/java-serialization.html#7-序列化技术选型)
- [8. 参考资料](https://dunwu.github.io/javacore/io/java-serialization.html#8-参考资料)
...
- [thrift (opens new window)](https://github.com/apache/thrift)、[protobuf (opens new window)](https://github.com/protocolbuffers/protobuf)- 适用于**对性能敏感，对开发体验要求不高**。
- [hessian (opens new window)](http://hessian.caucho.com/doc/hessian-overview.xtp)- 适用于**对开发体验敏感，性能有要求**。
- [jackson (opens new window)](https://github.com/FasterXML/jackson)、[gson (opens new window)](https://github.com/google/gson)、[fastjson (opens new window)](https://github.com/alibaba/fastjson)- 适用于对序列化后的数据要求有**良好的可读性**（转为 json 、xml 形式）。
